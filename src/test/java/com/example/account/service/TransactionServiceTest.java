...
class   TransactionServiceTest {
    ...
    void deleteAccountAccess_userUnMatch() {
        //given
    ...
    void deleteAccountAccess_alreadyUnregistered() {
        //given
        AccountUser pobi = AccountUser.builder()
                .name("Pobi").build();
        pobi.setId(12L);
    ...
    void successCancelBalance() {
        ...
        ArgumentCaptor<Transaction> captor = ArgumentCaptor.forClass(Transaction.class);
        //when
        TransactionDto transactionDto = transactionService.cancelBalance("transacntionId",
                "1000000000", AMOUNT);
        //then
        verify(transactionRepository, times(1)).save(captor.capture());
        assertEquals(AMOUNT, captor.getValue().getAmount());
